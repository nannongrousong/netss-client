...
import { initNavMenu, setActiveTab, closeNavTab, closeOtherNavTab, closeAllNavTab, editTabStore } from 'NETSS_ACTION/homeNav';
import { setAuthInfo } from 'NETSS_ACTION/authInfo';
import NavHeader from 'NETSS_COMPONENT_NAVHEADER';
import NavSlider from 'NETSS_COMPONENT_NAVSLIDER';
import NavTab from 'NETSS_COMPONENT_NAVTAB';
import Exception from 'NETSS_COMPONENT_EXCEPTION';
import { Load_User_Info } from 'NETSS_SERVICE/Sys_Auth';
import { setResource } from 'COMMON_COMPONENT/AuthResource';
import adminRouters from 'NETSS_ROUTER';
...
const createRouteInfo = (adminRouters, navMenu) => (
    <Switch>
        ...
        <Route path='/500' component={() => <Exception type='500' homePath='/netss/index' />} />
        <Route path='/403' component={() => <Exception type='403' homePath='/netss/index' />} />
        <Route path='*' component={() => <Exception type='404' homePath='/netss/index' />} />
    </Switch>
);
